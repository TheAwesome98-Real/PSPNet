                                    ...
                                    try {
                                        ...
                                        if ((n5 = array2[n4]) >= 100 && n5 <= 118 && n5 != 108 && n5 != 113 && n5 != 117) {
                                            ...
                                            for (int k = 0; k < countValues; ++k) {
                                                final StringBuffer obj2 = new StringBuffer();
                                                if (fieldDataType == 4) {
                                                    final String string;
                                                    if ((string = ((PIMItem)contact).getString(n5, k)) != null) {
                                                        obj2.append('\"').append(Code(string)).append('\"');
                                                    }
                                                }
                                                    ...
                                                    for (int l = 0; l < stringArray.length; ++l) {
                                                        if (stringArray[l] != null && stringArray[l].length() > 0) {
                                                            obj2.append('\"').append(Code(stringArray[l])).append("\",");
                                                        }
                                                    }
                                                    obj2.setCharAt(obj2.length() - 1, ']');
                                                }
                                                if (obj2.length() > 2) {
                                                    obj.append((Object)obj2).append(',');
                                                }
                                            }
                                            obj.setCharAt(obj.length() - 1, ']');
                                            if (obj.length() > 1) {
                                                if (sb2.length() > 0) {
                                                    sb2.append(',');
                                                }
                                                sb2.append('\"').append((char)n5).append("\":").append((Object)obj);
                                            }
                                        }
                                    }
                                    finally {
